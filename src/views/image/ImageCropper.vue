  ...
  <div class="image-cropper-wrapper">
    <Hints>
      ...
      <template slot="hintInfo">
        ...
        <p>github地址：访问 <el-link type="success" href="https://github.com/xyxiao001/vue-cropper"
            target="_blank">Vue-Cropper</el-link></p>
      </template>
    </Hints>
    <el-row :gutter="20">
      <el-col :span="10">
        <el-card shadow="always">
          ...
          <div class="content-box" style=" height: 400px;">
            <VueCropper ref="cropper" :img="configObj.imgSrc" :can-move="configObj.canMove"
              :auto-crop="configObj.autoCrop" :center-box="configObj.centerBox" :info-true="configObj.infoTrue"
              :full="configObj.full" :auto-crop-width="configObj.autoCropWidth"
              :auto-crop-height="configObj.autoCropHeight" :output-type="configObj.outputType" @realTime="realTime" />
          </div>
        </el-card>
      </el-col>
      <el-col :span="4">
