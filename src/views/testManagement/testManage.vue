<template>
  <div class="table-classic-wrapper">
    ...
    <el-card shadow="always">
      ...
      <el-table ref="multipleTable" v-loading="listLoading" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column prop="score" label="题目分数" align="center" width="80">
          <template slot-scope="scope">
            <el-input v-model="scope.row.score" placeholder="分数" v-if="scope.row.scoreFlag">
            </el-input>
          </template>
        </el-table-column>
      ...
      <!-- 新增/编辑 弹出栏 -->
      <el-dialog title="编辑" :visible.sync="formVisible" width="35%" class="dialog-form" :before-close="handleClose">
        <el-form ref="newQuestionForm" :model="newQuestionForm" :rules="formRules" label-width="100px">
      ...
      <!-- 组卷弹出栏 -->
      <el-dialog title="组卷" :visible.sync="testVisible" width="35%" class="dialog-form" :before-close="handleTestClose">
        <el-form ref="testForm" :model="testForm" :rules="testFormRules" label-width="100px">
