  ...
  <div class="vue-drr-wrapper">
    <Hints>
      ...
      <template slot="hintInfo">
        ...
        <p>github地址：访问 <el-link type="success" href="https://github.com/Alvin-Liu/vue-drr"
            target="_blank">VueDRR</el-link></p>
      </template>
    </Hints>
    <el-card shadow="always">
      <div slot="header" class="title">组件拖拽</div>
      <div class="drag-area">
        <VueDrr :x="configObj.x" :y="configObj.y" :w="configObj.width" :h="configObj.height" :minw="configObj.minW"
          :minh="configObj.minH" :active="configObj.active" :angle="configObj.angle" :parent="configObj.parent"
          @dragging="handleDragging" @resizing="handleResizing" @rotating="handleRotating">
          <div class="drag-box">
            <p>x: {{ configObj.x }}</p>
            <p>y: {{ configObj.y }}</p>
